...
Shader "Chibis/PortalSurface"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = tex2D( _MainTex1, ase_screenPosNorm.xy ).rgb;
			o.Alpha = 1;
		}
